...
namespace {
    ...
    public:
        ...
        {
          for(auto i = key_set_.lwb_i(k.memtable_key().data());
              i != key_set_.end_i() && callback_func(callback_args, key_set_.key(i)); i = key_set_.next_i(i));
        }
        ...
        class Iterator : public MemTableRep::Iterator
        {
            ...
            Iterator(key_set_t *tree) : tree_(tree), where_(tree_->end_i())
            {
            }
        ...
        virtual MemTableRep::Iterator *GetIterator(Arena *arena = nullptr) override
        {
          ...
          return new(mem) TRBTreeRep::Iterator(&key_set_);
        }
    };
